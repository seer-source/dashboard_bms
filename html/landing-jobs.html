                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-7 col-xl-8">
                            <div class="my-4">
                                <h2 class="fw-semibold mb-3 text-fixed-white">Are You Looking For A Job? Just <a href="javascript:void(0);" class="text-fixed-white text-decoration-line"> <u>drop</u> </a> resume..</h2>
                            ...
                            <div class="card custom-card featured-jobs">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <h6 class="fw-semibold mb-0 text-default">$25,000 - $35,000</h6>
                                        <a href="" class="text-primary fw-semibold fs-14 d-inline-flex align-items-center">
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-8 my-4">
                            <h2 class="fw-semibold mb-3">Are You Looking For A best Candidate? <br> Just <a href="javascript:void(0);" class="text-primary text-decoration-line"> <u>Publish</u> </a> your job here..</h2>
                        ...
                        <div class="col">
                            <div class="card custom-card border shadow-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fw-semibold mb-1">How to prepare an interview?</h5>
                                    ...
                                    <a class="text-primary fw-semibold" href="javascript:void(0);">Read this post<i class="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card custom-card border shadow-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fw-semibold mb-1">Freelancer vs Employement</h5>
                                    <p class="card-text">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                    <a class="text-primary fw-semibold" href="javascript:void(0);">Read this post<i class="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card custom-card border shadow-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fw-semibold mb-1">Job opportunity in jobmaster</h5>
                                    <p class="card-text">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                    <a class="text-primary fw-semibold" href="javascript:void(0);">Read this post<i class="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></a>
                                </div>
                            </div>
